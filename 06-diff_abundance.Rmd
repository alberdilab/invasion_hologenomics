...
```{r ancombc_mag, message=FALSE, warning=FALSE}
...
```{r ancombc_gen, message=FALSE, warning=FALSE}
set.seed(1234) #set seed for reproducibility
...
```{r ancombc_fam, message=FALSE, warning=FALSE}
set.seed(1234) #set seed for reproducibility
...
```{r ancombc_plot_fam, message=FALSE, warning=FALSE, fig.height=10, fig.width=8, fig.fullwidth=TRUE}
...
```{r ancombc_phy, message=FALSE, warning=FALSE}
set.seed(1234) #set seed for reproducibility
...
```{r ancom_table, message=FALSE, warning=FALSE}
