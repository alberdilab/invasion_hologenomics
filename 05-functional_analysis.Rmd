...
```{r element_community_GIFT, warnings=F, fig.width=10, fig.height=8}
...
```{r function_community_GIFTs, warning=FALSE, fig.width=10, fig.height=8}
...
```
```{r, functions_species_GIFT, fig.height=10, fig.width=10 }
...
```{r function_community_factors, echo=T, results='hide'}
