...
# Fixed effects formula (old formulas)
XFormula5 = ~index500 + species + season + logseqdepth
XFormula6 = ~index500*species + season + logseqdepth
XFormula7 = ~index500 + species*season + logseqdepth
XFormula8 = ~index500*species + season*species + logseqdepth
...
model_list = list(model5=model5,model6=model6,model7=model7,model8=model8)
