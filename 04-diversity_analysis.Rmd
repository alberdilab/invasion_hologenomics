...
```{r neutral_brm, message=FALSE, warning=FALSE, results='hide'}
...
#conditional effects
neutral_eff <- (conditional_effects(neutral.brm, effects = "index500:species"))
neutral_df <- as.data.frame(neutral_eff$'index500:species')
...
#plot(rope(phylo.brm, ci = 1))


#conditional effects
phylo_eff <- (conditional_effects(phylo.brm, effects = "index500:species"))
phylo_df <- as.data.frame(phylo_eff$'index500:species')
