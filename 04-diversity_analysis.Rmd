...
adonis2(formula=beta_q1n ~ species + index500 + season + sex + development + species*index500 + species*season, 
...
adonis2(formula=beta_red ~ season + index500 + sex + development, 
        data=metadata_adonis_red[labels(beta_red),], permutations=hr_red, na.action = na.omit) %>%
  as.matrix() %>%
  print()


dispersion_red <- betadisper(beta_red, group=metadata_adonis_red$season)
#plot(dispersion, main="PCoA")
...
adonis2(formula=beta_grey ~ season + index500 + sex + development, 
        data=metadata_adonis_grey[labels(beta_grey),], permutations=hr_grey, na.action = na.omit) %>%
  as.matrix() %>%
  print()

dispersion_grey <- betadisper(beta_grey, group=metadata_adonis_grey$season)
#plot(dispersion, main="PCoA")
