...
diversity.data$season <-factor(diversity.data$season, levels = c("spring-summer", "autumn", "winter"))

```

```{r var_distrib, include=FALSE}
...
```{r neutral_diagnostics, include=FALSE}
...
neutral.model2<-lmer(neutral ~ species + BU + season
            + species:BU + species:season
            + (1|animal),
            data=diversity.data, na.action=na.omit,
            control=lmerControl(optimizer="bobyqa",
                                optCtrl=list(maxfun=2e5)))
...
```{r phylo_diagnostics, include=FALSE}

resid_panel(phylo.model, smoother = TRUE, qqbands = TRUE)

```

```{r phylo_posthoc, include=FALSE}
...
phylo.model2<-lmer(phylo ~ species + BU + season
                    + species:BU + species:season
                    + (1|animal),
                    data=diversity.data, na.action=na.omit,
                    control=lmerControl(optimizer="bobyqa",
...
```{r func2_diagnostics, include=FALSE}

resid_panel(func2.model, smoother = TRUE, qqbands = TRUE)

```

```{r func2_posthocs, include=FALSE}
...
func2.model2<-lmer(func2 ~ species + BU + season
                  + species:BU + species:season
                  + (1|animal),
                  data=diversity.data, na.action=na.omit,
                  control=lmerControl(optimizer="bobyqa",
