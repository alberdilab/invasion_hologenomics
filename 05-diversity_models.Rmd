...
neutral.model2<-lmer(neutral ~ species + builtup + season 
            + species:builtup + species:season
            + (1|animal), 
            data=diversity.data, na.action=na.omit, 
            control=lmerControl(optimizer="bobyqa", 
                                optCtrl=list(maxfun=2e5)))
...
phylo.model2<-lmer(phylo ~ species + builtup + season 
                    + species:builtup + species:season 
                    + (1|animal), 
                    data=diversity.data, na.action=na.omit, 
                    control=lmerControl(optimizer="bobyqa", 
...
lsm_seas <- lsmeans(func2.model, specs= ~ species:season)
Sc.ss <- c(1, 0, 0, 0, 0, 0)
Sc.au <- c(0, 0, 1, 0, 0, 0)
Sc.wi <- c(0, 0, 0, 0, 1, 0)
Sv.ss <- c(0, 1, 0, 0, 0, 0)
...
func2.model2<-lmer(func2 ~ species + builtup + season 
                  + species:builtup + species:season 
                  + (1|animal), 
                  data=diversity.data, na.action=na.omit, 
                  control=lmerControl(optimizer="bobyqa", 
