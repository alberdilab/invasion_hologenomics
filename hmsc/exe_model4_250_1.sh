...
fitname = "hmsc/fit_model4_250_1.Rdata"
convname = "hmsc/conv_model4_250_1.Rdata"
sample = 250
thin = 1
nchains = 4
...
save(psrf.beta.model4_250_1, psrf.gamma.model4_250_1, psrf.rho.model4_250_1, file=convname)
