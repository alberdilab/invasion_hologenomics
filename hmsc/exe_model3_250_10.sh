#!/bin/bash
#SBATCH --job-name=hmsc_model3_250_10                   # Job name
#SBATCH --nodes=1
...
fitname = "hmsc/fit_model3_250_10.Rdata"
convname = "hmsc/conv_model3_250_10.Rdata"
sample = 250
thin = 10
nchains = 4
...
save(psrf.beta.model3_250_10, psrf.gamma.model3_250_10, psrf.rho.model3_250_10, file=convname)
