#!/bin/bash
#SBATCH --job-name=hmsc_model.3a_250_10                   # Job name
#SBATCH --nodes=1
...
modelname = "model.3a"
model = model_list$model.3a
fitname = "hmsc/fit_model.3a_250_10.Rdata"
convname = "hmsc/conv_model.3a_250_10.Rdata"
sample = 250
thin = 10
nchains = 4
...
save(psrf.beta.model.3a_250_10, psrf.gamma.model.3a_250_10, psrf.rho.model.3a_250_10, file=convname)
