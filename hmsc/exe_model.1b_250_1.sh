#!/bin/bash
#SBATCH --job-name=hmsc_model.1b_250_1                   # Job name
#SBATCH --nodes=1
...
fitname = "hmsc/fit_model.1b_250_1.Rdata"
convname = "hmsc/conv_model.1b_250_1.Rdata"
sample = 250
thin = 1
nchains = 4
...
save(psrf.beta.model.1b_250_1, psrf.gamma.model.1b_250_1, psrf.rho.model.1b_250_1, file=convname)
