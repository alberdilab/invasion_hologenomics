#!/bin/bash
#SBATCH --job-name=hmsc_model.3b_250_10                   # Job name
#SBATCH --nodes=1
...
modelname = "model.3b"
model = model_list$model.3b
fitname = "hmsc/fit_model.3b_250_10.Rdata"
convname = "hmsc/conv_model.3b_250_10.Rdata"
sample = 250
thin = 10
nchains = 4
...
save(psrf.beta.model.3b_250_10, psrf.gamma.model.3b_250_10, psrf.rho.model.3b_250_10, file=convname)
