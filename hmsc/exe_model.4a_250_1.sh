#!/bin/bash
#SBATCH --job-name=hmsc_model.4a_250_1                   # Job name
#SBATCH --nodes=1
...
fitname = "hmsc/fit_model.4a_250_1.Rdata"
convname = "hmsc/conv_model.4a_250_1.Rdata"
sample = 250
thin = 1
nchains = 4
...
save(psrf.beta.model.4a_250_1, psrf.gamma.model.4a_250_1, psrf.rho.model.4a_250_1, file=convname)
