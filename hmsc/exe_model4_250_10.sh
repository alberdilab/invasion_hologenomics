...
modelname = "model4"
model = model_list$model4
fitname = "hmsc/fit_model4_250_10.Rdata"
convname = "hmsc/conv_model4_250_10.Rdata"
sample = 250
thin = 10
nchains = 4
...
save(psrf.beta.model4_250_10, psrf.gamma.model4_250_10, psrf.rho.model4_250_10, file=convname)
