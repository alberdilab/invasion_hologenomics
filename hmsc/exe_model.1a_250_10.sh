#!/bin/bash
#SBATCH --job-name=hmsc_model.1a_250_10                   # Job name
#SBATCH --nodes=1
...
modelname = "model.1a"
model = model_list$model.1a
fitname = "hmsc/fit_model.1a_250_10.Rdata"
convname = "hmsc/conv_model.1a_250_10.Rdata"
sample = 250
thin = 10
nchains = 4
...
save(psrf.beta.model.1a_250_10, psrf.gamma.model.1a_250_10, psrf.rho.model.1a_250_10, file=convname)
