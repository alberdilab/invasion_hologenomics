...
levels.1b <- c("species","index500","season","logseqdepth","Random: animal", "Random: metapop")
levels.2a <- c("species","index500","season","species:index500","logseqdepth","Random: animal")
levels.2b <- c("species","index500","season","species:index500","logseqdepth","Random: animal", "Random: metapop")
levels.3a <- c("species","index500","season","species:season","logseqdepth","Random: animal")
levels.3b <- c("species","index500","season","species:season","logseqdepth","Random: animal", "Random: metapop")
levels.4a <- c("species","index500","season","species:index500","species:season","logseqdepth","Random: animal")
levels.4b <- c("species","index500","season","species:index500","species:season","logseqdepth","Random: animal", "Random: metapop")
...
varpart$vals %>%
   ...
   mutate(variable=factor(variable, levels=levels.4b)) %>%
   group_by(variable) %>%
...
vertical_tree <-  varpart_tree +
        scale_fill_manual(values=c("#34738f","#cccccc","#ed8a45","#b2b530","#be3e2b","#f6de6c","#83bb90", "pink"))+
